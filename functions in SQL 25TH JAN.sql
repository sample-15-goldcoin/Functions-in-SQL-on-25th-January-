...
(105, 'Ayesha Khan', 'Python', 67, 81, 'Ms.Iyer', '2023-07-10', 'Hyderabad'), 
(106, 'Dev Sharma', 'SQL', 73, 78, 'Mr.Iyer', '2023-05-28', 'Pune'), 
(107, 'Arjun Sharma', 'Tableau', 95, 98, 'Ms.Kapoor', '2023-06-15', 'Delhi'), 
...
##Question 2. Show each student's score and the previous student's score (basedon score order). 
SELECT 
name, 
score, 
